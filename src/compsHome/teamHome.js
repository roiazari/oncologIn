    ...
    <div class="team container-fluid bg-secondary d-flex align-items-center">
        <div class="container">
            ...
            <div class="row text-center mt-4">
                ...
                data-aos-easing="ease-out-cubic"
                data-aos-duration="2000">
                    <img src="images/pic3.jpg" class="w-50 mb-3 border border-4 border-white" alt="pic"/>
                    <h3>Ofer Shelly</h3>
                    <h4>Boss</h4>
                </div>
                <div class="box col-lg-3 col-sm-6" data-aos="flip-left"
                ...
                data-aos-easing="ease-out-cubic"
                data-aos-duration="2000">
                    <img src="images/pic4.jpg" class="w-50 mb-3 border border-4 border-white" alt="pic"/>
                    <h3>Michael Gabay</h3>
                    <h4>U/UX manager</h4>
                </div>
            </div>
